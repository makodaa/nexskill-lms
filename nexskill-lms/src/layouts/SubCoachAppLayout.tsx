        ...
        <aside className="w-[240px] flex-shrink-0 flex flex-col p-6 border-r border-[#EDF0FB] dark:border-gray-700">
          ...
          <div className="mb-8">
            <Link to="/subcoach/dashboard" className="flex items-center gap-3">
              ...
              <div>
                <span className="text-xl font-bold text-teal-600 dark:text-teal-400 block leading-tight">NexSkill</span>
                <span className="text-xs text-slate-600 dark:text-gray-400">Sub-Coach Portal</span>
              </div>
            </Link>
          </div>
              ...
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${
                  isActive(item.path)
                    ...
                    : 'text-text-secondary dark:text-dark-text-secondary hover:bg-teal-50 dark:hover:bg-gray-800 hover:text-teal-700 dark:hover:text-teal-400'
                }`}
              >
          ...
          <div className="pt-6 mt-6 border-t border-[#EDF0FB] dark:border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-text-muted dark:text-dark-text-muted">Assistant Instructor</p>
              </div>
            </div>
          </div>
        </aside>
