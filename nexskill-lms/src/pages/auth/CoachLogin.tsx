        ...
        <StudentAuthLayout maxWidth="small">
            <div className="w-full max-w-md mx-auto">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Coach Login</h1>
                    <p className="text-xl font-medium text-brand-primary mb-1">Coach Access</p>
                    <p className="text-gray-500 dark:text-gray-400">Sign in to manage your courses and students</p>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700 text-center space-y-3">
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                        Want to become a Coach? <Link to="/coach/apply" className="text-brand-primary hover:underline font-medium">Apply Here</Link>
                    </p>
                    <div className="flex justify-center gap-4 text-xs text-gray-400">
                        <Link to="/student/login" className="hover:text-gray-600 dark:hover:text-gray-200 transition-colors">Student Login</Link>
                        <span>|</span>
