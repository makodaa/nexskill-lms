        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className={`p-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-2 ${accountType === 'STUDENT'
            ...
            >
              ...
              <span className={`font-semibold ${accountType === 'STUDENT'
            ...
            <button
              ...
              className={`p-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-2 ${accountType === 'COACH'
                  ? 'border-brand-primary bg-brand-primary-soft dark:bg-blue-900/30 shadow-md'
                  : 'border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-800 hover:border-brand-primary-light dark:hover:border-blue-500'
                }`}
            >
              <div className="text-3xl">👨‍🏫</div>
              <span className={`font-semibold ${accountType === 'COACH'
                  ? 'text-brand-primary dark:text-blue-400'
                  : 'text-text-primary dark:text-white'
                }`}>
                Coach
        ...
        <form onSubmit={handleSignUp} className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-5 py-3 bg-[#F5F7FF] dark:bg-slate-700 rounded-full text-sm text-text-primary dark:text-white placeholder-text-muted dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-primary-light transition-all ${errors.firstName ? 'ring-2 ring-red-400' : ''
                  }`}
              />
              {errors.firstName && (
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-5 py-3 bg-[#F5F7FF] dark:bg-slate-700 rounded-full text-sm text-text-primary dark:text-white placeholder-text-muted dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-primary-light transition-all ${errors.lastName ? 'ring-2 ring-red-400' : ''
                  }`}
              />
              {errors.lastName && (
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-5 py-3 bg-[#F5F7FF] dark:bg-slate-700 rounded-full text-sm text-text-primary dark:text-white placeholder-text-muted dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-primary-light transition-all ${errors.username ? 'ring-2 ring-red-400' : ''
                }`}
            />
            {errors.username && (
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-5 py-3 bg-[#F5F7FF] dark:bg-slate-700 rounded-full text-sm text-text-primary dark:text-white placeholder-text-muted dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-primary-light transition-all ${errors.email ? 'ring-2 ring-red-400' : ''
                }`}
            />
            {errors.email && (
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-5 py-3 pr-12 bg-[#F5F7FF] dark:bg-slate-700 rounded-full text-sm text-text-primary dark:text-white placeholder-text-muted dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-primary-light transition-all ${errors.password ? 'ring-2 ring-red-400' : ''
                  }`}
              />
              <button
                type="button"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-5 py-3 pr-12 bg-[#F5F7FF] dark:bg-slate-700 rounded-full text-sm text-text-primary dark:text-white placeholder-text-muted dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-primary-light transition-all ${errors.confirmPassword ? 'ring-2 ring-red-400' : ''
                  }`}
              />
              <button
                type="button"
