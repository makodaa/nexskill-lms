          ...
          <div className="flex-1 overflow-y-auto">
            {conversations.map((conv) => (
              <div
                ...
                className={`p-4 hover:bg-[#F5F7FF] dark:hover:bg-gray-800 cursor-pointer transition-colors ${
                  selectedConversation === conv.id ? 'bg-[#F5F7FF] dark:bg-gray-800 border-l-4 border-brand-primary' : ''
                }`}
              >
