...
const CoachApplicationPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 overflow-x-hidden">
            ...
            <header className="sticky top-0 z-50 bg-white/80 dark:bg-slate-800/80 backdrop-blur-md border-b border-gray-100 dark:border-slate-700">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <button
                            onClick={() => navigate(-1)}
                            className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors text-gray-600 dark:text-gray-400"
                        >
                    ...
                    <p className="hidden sm:block text-sm text-gray-500 dark:text-gray-400 font-medium">Coach Application Portal</p>
                </div>
            </header>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <div className="flex flex-col lg:flex-row gap-12 items-start">
                    {/* Left Side: Pitch & Map */}
                    <div className="flex-1 w-full lg:w-1/2 space-y-8 lg:sticky lg:top-24">
                        <div>
            ...
            <footer className="mt-12 py-6 text-center text-xs text-gray-400 border-t border-gray-100 dark:border-slate-700">
