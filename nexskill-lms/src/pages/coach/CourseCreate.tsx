    ...
    <CoachAppLayout>
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="bg-white border-b border-slate-200 px-8 py-6">
          ...
          <p className="text-slate-600">Set up the basics to get started</p>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-5 py-3 bg-slate-50 rounded-xl border border-slate-200 focus:border-[#304DB5] focus:outline-none focus:ring-2 focus:ring-blue-100 transition-all"
                    required
                  />
                  <p className="text-xs text-slate-500 mt-2">Choose a clear, descriptive title</p>
                </div>
