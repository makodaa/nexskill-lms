...
type DripMode = 'immediate' | 'days-after-enrollment' | 'specific-date';
...
const DripSchedulePanel: React.FC<DripSchedulePanelProps> = ({ modules, onChange }) => {
  ...
  return (
    <div>
      ...
      <div className="mt-6">
        <button className="w-full py-3 px-6 bg-gradient-to-r from-[#304DB5] to-[#5E7BFF] text-white font-semibold rounded-full hover:shadow-lg transition-all">
          Save drip schedule
        </button>
      </div>
    </div>
