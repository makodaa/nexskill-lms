...
const CourseCategorySidebar: React.FC<CourseCategorySidebarProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-card p-6 sticky top-6 transition-colors">
      <h3 className="text-lg font-semibold text-text-primary dark:text-white mb-4">Categories</h3>
      ...
      {/* Course Count Info */}
      <div className="mt-6 p-4 bg-[#F5F7FF] dark:bg-slate-700 rounded-2xl transition-colors">
