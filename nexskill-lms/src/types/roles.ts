...
export const roleDescriptions: Record<UserRole, string> = {
  ...
  ADMIN:
    "Platform administrator with extensive permissions. Manages users, courses, moderation, analytics, and system settings.",
  COACH:
    "Course instructor and mentor. Creates and manages courses, interacts with students, and accesses coaching tools.",
  SUB_COACH:
